...
func TestLoadConfigFromFile(t *testing.T) {
	...
	t.Run("InvalidJSON", func(t *testing.T) {
		...
		if _, err := loadConfigFromFile(fp, testLogger(), NewDroppedServersStore()); err == nil {
...
func TestLoadConfigFromURL(t *testing.T) {
	...
	t.Run("ValidResponse", func(t *testing.T) {
		...
		servers, err := loadConfigFromURL(ctx, client, ts.URL, "user", "pass", 1, testLogger(), NewDroppedServersStore())
		if err != nil {
	...
	t.Run("ErrorResponse", func(t *testing.T) {
		...
		_, err := loadConfigFromURL(ctx, client, ts.URL, "", "", 1, testLogger(), NewDroppedServersStore())
		if err == nil {
	...
	t.Run("InvalidURL", func(t *testing.T) {
		_, err := loadConfigFromURL(ctx, client, "://invalid-url", "", "", 1, testLogger(), NewDroppedServersStore())
...
func TestRefreshConfig(t *testing.T) {
	...
	go func() {
		defer close(done)
		refreshConfig(ctx, client, mockServer.URL, "testuser", "testpass", cfg, NewDroppedServersStore(), testLogger, 100*time.Millisecond, 1, func(servers []models.ObaServer) {
			select {
...
func TestRefreshConfigKeepsPreviousConfigWhenResponseIsEmpty(t *testing.T) {
	...
	go func() {
		defer close(done)
		refreshConfig(ctx, ts.Client(), ts.URL, "", "", cfg, NewDroppedServersStore(),
