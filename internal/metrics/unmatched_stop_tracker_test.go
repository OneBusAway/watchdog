...
func TestUnmatchedStopTrackerTracksByAgency(t *testing.T) {
	...
	tracker.RecordLastSeen("agency-a", "agency-a", "Agency A", "stop-1", "Stop One", "1.100000", "2.200000")
	tracker.RecordClusterSeen("agency-a", "agency-a", "Agency A", "station-1", "s2_111", "1.100000", "2.200000")
	tracker.RecordLastSeen("agency-b", "agency-b", "Agency B", "stop-1", "Stop One", "1.100000", "2.200000")
...
func TestRecordLastSeenUpdatesLabelsOnRename(t *testing.T) {
	...
	tracker.RecordLastSeen(agencyID, agencyID, "Rename Agency", stopID, "Old Name", "1.100000", "2.200000")

	ObaUnmatchedStopInfo.WithLabelValues(agencyID, "Rename Agency", stopID, "New Name", "3.300000", "4.400000").Set(1)
	tracker.RecordLastSeen(agencyID, agencyID, "Rename Agency", stopID, "New Name", "3.300000", "4.400000")
...
func TestClearStopsPrunesRenamedStopOnStale(t *testing.T) {
	...
	tracker.RecordLastSeen(agencyID, agencyID, "Rename Clear Agency", stopID, "Very Old Name", "1.100000", "2.200000")

	ObaUnmatchedStopInfo.WithLabelValues(agencyID, "Rename Clear Agency", stopID, "Latest Name", "9.900000", "8.800000").Set(1)
	tracker.RecordLastSeen(agencyID, agencyID, "Rename Clear Agency", stopID, "Latest Name", "9.900000", "8.800000")
